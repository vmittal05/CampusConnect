...
else
{
  ...
  $Conatct="";
  $email="";
    $sql = "SELECT name,price,cond,imgpath,author,uid FROM books where name='$name'";
...
function myFunction() {
    ...
    window.location.href = "delbooks.php";
}
...
<div class="container custom-container">
    ...
    <div class="d-flex w-100 justify-content-between">
      ...
      <br><br><br><br>
      <p class="block align-top" id="new"><?php echo $Amodel; ?></p>
