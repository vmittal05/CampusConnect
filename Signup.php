...
?>
          ...
          <input type="text" name="batch" value="<?php echo $batch;?>" class="form-control" placeholder="Eg : Bxx"> 
          </div><br>
          <div class="input-group input-group-lg col-lg-6 col-md-offset-3">
          <span class="input-group-addon">Enrollment No.:</span>
          <input type="text" name="enroll" value="<?php echo $enroll;?>" class="form-control" placeholder="Eg : 1510xxxx"> <span class="star">*</span>
