...
$test="rrrr";
  ...
  $Aimgpath="";
  $Aauthor="";
    $sql = "SELECT name,price,cond,imgpath,author FROM books";
...
<script type="text/javascript">
  function showform()
    ...
    "<div class='d-flex w-100 justify-content-between'>"+
      ...
      "<p class='block' id='son'><?php echo $Aauthor; ?></p>"+
      "<p class='block' id='cond'>Condition : <span id='wer'><?php echo $Acond; ?></span></p>"+
      "<p id='price'>Price :</p>"+
      "<p id='pricereal'>Rs.<?php print $Aprice; ?></p>"+
      "<form id='passv' method='post' action='afterbuyBook.php'></form>"+
      "<button type='submit' id='itsb' form='passv' class = 'btn btn-warning btn-lg' name='getName' onclick='checklog()' value='<?php echo $Aname; ?>' >Buy Now</button>"+
      "<br><br>"+
      "</div>"+
  "</div>";
