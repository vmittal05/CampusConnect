...
$test="rrrr";
  ...
  $Aimgpath="";
  $Atype="";
    $sql = "SELECT name,price,cond,imgpath,type FROM games where name='$name'";
...
<div class="container custom-container">
	<div class="jumbotron">
  	...
  	<h2 align="center">Your Order Summary</h2>
  	<hr>
    ...
    <div id="details">
    	...
    	<p>Name &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : ABC</p>
    	<p>Contact No.&nbsp&nbsp&nbsp&nbsp&nbsp: 9582920618</p>
    	<p>Email Address : abg@gmail.com</p>
    </div>
    <button type="submit" id="final" class = "btn btn-success btn-lg" onclick="myFunction()">Confirm</button>
    <button type="button" id="finalwer" class = "btn btn-danger btn-lg" onclick="myCancel()">Cancel</button>
