...
<?php 
          $form = $email = $price = $mob = $name = $genre =  "";
...
<div class="container custom-container">
	...
	<form action="mediareq.php" method="POST" id="myForm">
		<div class="form-row">
			<div class="form-group col-lg-6 col-md-6">
				<label for="inputType">Genre</label>
				<select id="inputType" name="genre" class="form-control">
					<option>Movie</option>
			...
			<div class="form-group col-lg-6 col-md-6">
      			...
      			<input type="text" class="form-control" name="name" id="inputBrand" placeholder="eg : Sherlock"><span class="star">*</span>
          <span class="error"><?php echo $nameErr;?></span>
    		...
    		<div class="form-group col-lg-6 col-md-6">
				...
				<select id="inputCond" name="form" class="form-control">
